...
public class CustomExperimentManagerApplication {

    public static void main(String[] args) {
        CustomExperimentManager experimentManagerUI = new CustomExperimentManager();
...
class BacteriaPopulationCuston {
    private String name;

    public BacteriaPopulationCuston(String name) {
        this.name = name;
    }
